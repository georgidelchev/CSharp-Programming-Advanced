...
namespace P07_FamilyTree
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            CheckingIsBirthday(personInput, mainPerson);
            ...
            PrintChildrens(mainPerson);
        }

        private static void CheckingIsBirthday(string personInput, Person mainPerson)
        {
        ...
        private static void PrintChildrens(Person mainPerson)
        {
        ...
        private static void SetChild(List<Person> familyTree, Person parentPerson, string child)
        {
            ...
            if (IsBirthday(child))
            {
                ...
                {
                    childPerson = familyTree
                        .First(p => p.Birthday == child);
                }
            }
            else
            {
